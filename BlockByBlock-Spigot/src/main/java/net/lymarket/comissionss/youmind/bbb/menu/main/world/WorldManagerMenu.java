...
public class WorldManagerMenu extends UpdatableMenu {
    ...
    public void handleMenu(InventoryClickEvent e){
        ...
        if (NBTItem.hasTag(item, "type")){
            String type = NBTItem.getTag(item, "type");
            ...
            } else if (type.equals("world-member")){
                new MemberWorlds(playerMenuUtility, targetUserUUID).open();
            }
    ...
    public void setMenuItems( ){
        ...
        inventory.setItem(8, new ItemBuilder(XMaterial.REDSTONE.parseItem())
                .setDisplayName("&bMundos donde eres Miembro")
                .addTag("type", "world-member")
                .build());
